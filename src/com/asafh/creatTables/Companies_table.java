...
public class Companies_table {
	
	public static final String  CREATE_CATEGORY_TABLE_STATEMENT="CREATE TABLE `coupons_system`.`companies` "
			+ "(  `id` INT NOT NULL AUTO_INCREMENT, "
			+ " `name` VARCHAR(45) NOT NULL, "
			+ " `email` VARCHAR(45) NOT NULL, "
			+ " `password` VARCHAR(45) NOT NULL, "
			+ " PRIMARY KEY (`id`));";
	public static final String DROP_CATEGORY_TABLE_STATEMENT="DROP TABLE `coupons_system`.`companies`";  
